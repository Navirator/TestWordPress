...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/child2/features/child2-slider.php';
...
if ( ! function_exists( 'ecommerce_comp_retailsy_frontpage_sections' ) ) :
	function ecommerce_comp_retailsy_frontpage_sections() {	
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/child2/sections/section-slider.php';
