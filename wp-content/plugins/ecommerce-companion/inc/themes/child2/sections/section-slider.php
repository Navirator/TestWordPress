...
if ( ! function_exists( 'ecommerce_comp_retailsy_slider' ) ) :
	...
	$slider_bg_img 			= get_theme_mod('slider_bg_img', esc_url(ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/child2/assets/images/homepage1/page-slider/slider.png'));
	$slider_product_img		= get_theme_mod('slider_product_img', esc_url(ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/child2/assets/images/homepage1/page-slider/product.png'));
