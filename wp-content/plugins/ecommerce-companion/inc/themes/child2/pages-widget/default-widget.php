<?php
$child2_logo_url = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/child2/assets/images/footerlogo.png';
$activate = array(
    ...
    /* the default titles will appear */
		...
		1 => array('title' => '',
        'text'=>'<a href="#" class="logo"><img src="'.esc_url($child2_logo_url).'"></a>
	...
	$MediaId = get_option('child2_media_id');
