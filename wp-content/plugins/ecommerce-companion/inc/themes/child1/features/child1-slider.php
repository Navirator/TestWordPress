...
/*=========================================
    ...
    $wp_customize->add_setting( 
    	'slider_bg_img' , 
    	array(
			'default' 			=> esc_url(ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/child1/assets/images/homepage1/page-slider/slider.png'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'retailsy_sanitize_url',	
			'priority' => 10,
		) 
    ...
    $wp_customize->add_setting( 
    	'slider_product_img' , 
    	array(
			'default' 			=> esc_url(ECOMMERCE_COMP_PLUGIN_URL . 'inc/themes/child1/assets/images/homepage1/page-slider/product.png'),
			'capability'     	=> 'edit_theme_options',
			'sanitize_callback' => 'retailsy_sanitize_url',	
			'priority' => 11,
		) 
