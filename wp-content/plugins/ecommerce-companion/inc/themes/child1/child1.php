...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/child1/features/child1-slider.php';
...
function ecommerce_comp_retailsy_frontpage_sections() {	
		require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/child1/sections/section-slider.php';
